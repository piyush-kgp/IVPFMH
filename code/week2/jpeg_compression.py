...
def jpeg_compression(img):
    ...
    # Quantization: this is a proxy method. In reality we use a Quantization table.
    for threshold in [0.005, 0.012, 0.02, 0.05, 0.1, 0.2, 0.3]:
        # Below a threshold fraction of max coefficient value, all others will be capped to 0.
        ...
        save_img(img_rec, "images/recon_dct/reconstruction_lena_dct_{}.jpg".format(keep_perc))
        ...
        save_img(img_rec, "images/recon_fft/reconstruction_lena_fft_{}.jpg".format(keep_perc))
